...
def test_scan_finds_every_video(conn, library, fake_probe):
    ...
    assert result == {"total": 13, "added": 13, "updated": 0, "unchanged": 0, "failed": 0, "missing": 0, "removed": 0, "unreadable_folders": [], "unreadable_files": 0}
...
def test_rescan_without_changes_probes_nothing(conn, library, fake_probe):
    ...
    assert result == {"total": 13, "added": 0, "updated": 0, "unchanged": 13, "failed": 0, "missing": 0, "removed": 0, "unreadable_folders": [], "unreadable_files": 0}
